...
The transcriptome dataset recorded mRNA expression of 19,788 genes at 8 time points (0 hr to 72 hr).
PCA plots showed differences in gene expression at different time points. pc1 explained 61.4% of the variance, whereas pc2 accounted for 29.9% of the variance.
The clear trajectory from 0 to 72 hours shows a clear time course of gene expression, which reflects the beginning of the differentiation process.
...
In the proteomic PCA, PC1 explains 67.6% of the variance, which represents the majority of the variance in the proteomic data. pC2 explains 21% of the variance, which explains another portion of the variance in protein expression differences.

The PCA plot shows the separation of samples on the PC1 and PC2 axes, indicating significant changes in protein expression over time. And the trajectory in the PCA plot simultaneously shows the gradual change in protein levels during cell differentiation.
...
### h3k4me3 Exploration
The H3K4me3 dataset included histone modification levels at different time points of 1 h, 6 h, 24 h, 36 h, and 48 h. The H3K4me3 dataset was analyzed by PCA. PCA showed that PC1 explained 77.9% of the variance and PC2 explained 18.1% of the variance.

PCA plots show the distribution of H3K4me3 modification patterns at each time point. Similar time points (e.g., H3K4me3_36h and H3K4me3_48h) are clustered together, indicating that they have similar modification patterns.

In contrast, time points such as H3K4me3_1h and H3K4me3_24h are more dispersed, suggesting that histone modification patterns differ significantly at these stages of differentiation.
...
The H3K27me3 dataset captures histone modification levels at key time points from 0 to 48 h. PCA reality, 91.2% for PC1 and 8.1% for PC2, with PC1 indicating the major changes in H3K27me3 labeling.

The clustering observed in the PCA plots at later stages such as 36 and 48 hours reflects a convergent aggregation of gene repression patterns, whereas the divergence at 0 and early 1 hour indicates a clear onset of repression.
...
### H3K27ac Exploration
H3K27ac by PCA, with PC1 explaining 84% of the variance and PC2 13.5%. The PCA plots show that later time points such as 36 hours and 48 hours cluster together, indicating the similarity of these time points. In contrast, earlier time points such as 1 hour and 6 hours were significantly different.
...
### H3K4me1 Exploration
The H3K4me1 dataset includes 0, 1, 6, 12, 24, 36 and 48 hours. By PCA, PC1 showed 85% of the variance while PC2 showed 11.7% of the variance.

The PCA plots show a similar pattern at the early stages such as 0 hours and 1 hour. Whereas, a gradual differentiation pattern was observed at later stages such as after 12 hours, 36 hours and 48 hours.
...
### H3K9me2 Exploration
The H3K9me2 dataset consisted of 0 hours, 1 hour, 6 hours, 12 hours, 24 hours, 36 hours and 48 hours.

PCA shows that PC1 explains 83.6% of the variance and PC2 explains the other 13.1% of the variance.The PCA plot shows clustering of the early stages, with the 0-hour and 1-hour data clustered together, indicating similar levels. In contrast, later stages such as 36 and 48 hours show different patterns.
```
