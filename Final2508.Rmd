...
author: "A. Kapoor, D. Langreiter, U. Samant"
output:
  pdf_document:
...
```{r setup, echo=FALSE}
knitr::opts_chunk$set(tidy.opts=list(width.cutoff=60), format='tidy')
knitr::opts_chunk$set(echo = TRUE)
htmltools::tags$style("
  pre, code {
    white-space: pre-wrap; /* Code and outputs wrap */
    word-wrap: break-word; /* Break at word for long words */
    overflow-wrap: break-word; /* Ensures words can be broken */
  }
")
```
