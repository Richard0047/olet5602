...
plot(pca.h3k27ac$x[,1], pca.h3k27ac$x[,2], col=grp.col[grp], pch=19, cex=2, 
...
calibrate::textxy(pca.h3k27ac$x[,1], pca.h3k27ac$x[,2], labs=grp, cex=0.5)
...
plot(pca.h3k27me3$x[,1], pca.h3k27me3$x[,2], col=grp.col[grp], pch=19, cex=2, 
...
calibrate::textxy(pca.h3k27me3$x[,1], pca.h3k27me3$x[,2], labs=grp, cex=0.5)
...
plot(pca.h3k4me1$x[,1], pca.h3k4me1$x[,2], col=grp.col[grp], pch=19, cex=2, 
...
calibrate::textxy(pca.h3k4me1$x[,1], pca.h3k4me1$x[,2], labs=grp, cex=0.5)
...
plot(pca.h3k9me2$x[,1], pca.h3k9me2$x[,2], col=grp.col[grp], pch=19, cex=2, 
...
calibrate::textxy(pca.h3k9me2$x[,1], pca.h3k9me2$x[,2], labs=grp, cex=0.5)
...
plot(pca.polii$x[,1], pca.polii$x[,2], col=grp.col[grp], pch=19, cex=2, 
...
calibrate::textxy(pca.polii$x[,1], pca.polii$x[,2], labs=grp, cex=0.5)
